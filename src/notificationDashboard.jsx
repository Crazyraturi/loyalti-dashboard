...
const AdminNotificationDashboard = () => {
  ...
  const Sidebar = () => (
    <div className="bg-red-500 text-white w-52 min-h-screen p-4">
      <div className="flex items-center mb-8">
        <div className="bg-white text-red-500 px-2 py-1 rounded text-sm font-bold">
          GOFY
        </div>
        <span className="ml-2 text-sm">Kids Mall</span>
      </div>

      <nav className="space-y-2">
        <div className="flex items-center py-2 px-3 bg-red-600 rounded">
          <Bell size={16} className="mr-3" />
          <span className="text-sm">Notifications</span>
        </div>
        <div className="flex items-center py-2 px-3 hover:bg-red-600 rounded cursor-pointer">
      ...
      <div className="mt-auto pt-8">
        <div className="flex items-center">
          <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
            <span className="text-red-500 text-xs font-bold">SJ</span>
          </div>
          <div className="ml-3">
